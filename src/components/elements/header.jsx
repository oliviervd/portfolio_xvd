    ...
    <div className={"gridH-4-1 header"}>
      {props.isDesktopOrLaptop && (
        <div className="menu-item" onClick={props.initGrid}>
          ...
          {props.showBio && (
            <p>
              Xavier Van D'huynslager is a freelance Director of Photography
              based in Ghent, Belgium. -Available for global hire.
            </p>
          )}
        </div>
      )}
      ...
      <div className={"grid-5-1-4"}>
        ...
        <div className={"grid_even--4"}>
          ...
          <a
            href={"https://www.instagram.com/xaviervandhuynslager/"}
            target="_blank"
          >
          ...
          <a
            href={
              "https://www.linkedin.com/in/xavier-van-d-huynslager-bb1b27103/"
            }
            target="_blank"
          >
